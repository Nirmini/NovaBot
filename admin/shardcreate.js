...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (!shardManager) {
            await interaction.reply({ content: 'Sharding is not enabled for this bot.', flags: MessageFlags.Ephemeral });
            return;
        }
        ...
        try {
            ...
            await interaction.reply({ content: 'There was an error. Please try again later.', flags: MessageFlags.Ephemeral });
        }
    },
};
